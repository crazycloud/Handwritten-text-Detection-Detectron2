...
# --------------------------------------------------------
#https://github.com/jagin/detectron2-licenseplates/blob/master/licenseplates/evaluator.py
...
class VOCDetectionEvaluator(DatasetEvaluator):
    ...
    def evaluate(self):
        ...
        with tempfile.TemporaryDirectory(prefix=f"{self._dataset_name}_voc_eval_") as dirname:
